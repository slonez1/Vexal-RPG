...
def render_condition_badge(condition, cond_data, timer=0, hide_severity=False):
    """
    Render a condition badge like the original.
    If hide_severity True, the star severity marker is not shown (used for Vexal).
    """
    ...
    severity_text = "" if hide_severity else ("★" * severity)
